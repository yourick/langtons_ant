...
function App() {
    ...
    return (
        <div className="ant-base">
            <ControlPanel onSetData={setData} defaultData={defaultData} onSetDefaultData={setDefaultData} step={step} scale={scale} onSetScale={setScale} viewport={viewport} ant={ant}/>
